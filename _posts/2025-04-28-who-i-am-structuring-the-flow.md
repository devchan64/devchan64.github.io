...
제가 해온 일들을 돌이켜보며, 그 일들을 설명할 수 있는 언어를 찾고자 했습니다.

그때 자꾸 '아키텍트'라는 단어에 시선이 머물렀습니다.

하지만 단순히 역할을 가리키는 말로만 쓰고 싶지는 않았습니다.  
'아키텍트'라는 단어는, 그 속에 담겨야 할 구조적 사고의 깊이와,  
판단 가능한 기반을 만드는 책임까지 포함해야 한다고 생각하게 되었습니다.

저는 아키텍트를 **판단 가능한 구조를 만드는 사람** 이라고 정의하고 싶습니다.

- 기술을 고르는 사람이 아니라,  
- 기술을 고를 수 있는 조건을 만드는 사람.

무엇을 할지보다, **왜 그렇게 해야 하는지를 조직이 스스로 설명할 수 있도록 만드는 사람.**
...
- 더 많은 인력,  
- 더 많은 프로젝트,  
이 아니라, **문제를 다시 생기지 않게 만드는 구조**입니다.
