...
## 15. 동적 메모리 할당 오류(Dynamic Memory Allocation Error)
**문제 설명**:  
...
## 18. 비효율적인 메모리 액세스(Inefficient Memory Access)
