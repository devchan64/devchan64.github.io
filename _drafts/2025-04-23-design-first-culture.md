...
| 구분             | 등장 원인             | 핵심 목적        | 확산 배경                     | 전환 계기                        |
| ---------------- | --------------------- | ---------------- | ----------------------------- | -------------------------------- |
| **코드 컨벤션**  | 협업 가독성 문제      | 스타일 일관화    | 팀 확장, 리뷰 문화 정착       | 자동화 도구, AI 코드 생성        |
| **API-First**    | 계약 부재로 인한 충돌 | 명세 기반 협업   | OpenAPI, Swagger 생태계       | 서비스 경계 증가, 병렬 개발 필요 |
| **Design-First** | 설계 맥락 공유 부재   | 구조와 의도 공유 | 도메인 복잡성, 설계 책임 분화 | 명세만으론 부족한 협업 요구      |
