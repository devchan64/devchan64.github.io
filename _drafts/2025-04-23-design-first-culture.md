...
## 1. Introduction — 코드 컨벤션, 아직도 중요한가요?
...
- **소통이 명세를 중심으로 바뀝니다**  
  → 과거처럼 구현된 코드를 기준으로 논의하지 않고,  
     명세와 설계 기준을 중심으로 의사결정을 내립니다
...
기능이 늘어나고, 팀이 분화되며, 서비스가 분리될수록  
개발자들은 코드가 아니라 **구조**, 그리고 **판단의 흐름**을 공유해야 할 필요성을 느끼게 됩니다.
...
협업의 기준을 코드에서 명세로, 그리고 명세에서 설계로 이동시키고 있습니다.
