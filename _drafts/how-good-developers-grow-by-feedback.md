...
하지만 우리가 진짜 바라는 개발자의 모습이 명확히 정의되어 있다면,  
평가는 줄 세우는 도구가 아니라 **성장과 문화의 훈련 방식**이 될 수 있습니다.

이 글은 우리 팀이 어떻게 **좋은 개발자의 기준을 정의**하고,  
그 기준을 기반으로 **성과 평가를 문화로 운영**하며,  
궁극적으로 **신뢰할 수 있는 산출물을 팀에 축적하는 구조를 만드는가**에 대한 이야기입니다.
...
**그래서 가장 먼저 해야 할 일은, ‘좋은 개발자란 무엇인가’를 우리 팀이 스스로 정의하는 것입니다.**
...
현재 우리 팀이 중요하게 생각하는 기준은 다음과 같습니다:
...
> **삭제 가능성은 유지보수성과 확장성의 핵심 지표이며, 우리는 이러한 구조적 유연성을 팀 문화로 훈련합니다.**
...
## 🍝 복잡한 코드라도 설명할 수 있어야 한다

> **스파게티 코드는 반드시 설명을 남겨야 합니다.**

빠르게 대응해야 하거나, 도메인 요구가 복잡하거나, 시간 제약 속에서 구조 없이 구현되는 경우는 언제든 발생할 수 있습니다.  
우리는 그런 코드를 무조건 나쁘다고 보지 않습니다.

다만 그런 코드를 **그대로 남기는 것**은 팀 전체에 기술 부채를 남기는 행위입니다.

그래서 우리는 이렇게 정합니다:

> **스파게티 코드가 남는다면, 반드시 설명이 따라야 합니다.**

- 왜 이렇게 구현했는가? (제약, 우회, 임시 대응 등)  
- 어떤 대안이 있었는가?  
- 어떤 조건에서 이 코드는 사라질 수 있는가?  
- 리팩터링을 위해 어떤 단서를 남겼는가?

중요한 건 **완벽한 문서화가 아닙니다.**

> **그 코드를 작성한 개발자가 “그 순간 알고 있었던 맥락”을 뭐라도 남기는 것 자체가 충분히 의미 있는 문서입니다.**

우리는 이를 PR 설명, 위키, README, 주석 등 **어디든 남길 수 있도록 훈련하고, 그것이 팀 문화가 되도록 합니다.**

> **설명이 있는 스파게티 코드는 기술적 판단이고, 설명이 없는 스파게티 코드는 기술적 부채입니다.**
