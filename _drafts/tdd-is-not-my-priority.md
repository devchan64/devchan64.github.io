...
**ROS**(_Robot Operating System_)를 통해 확인할 수 있었습니다.

ROS는 메시지 기반의 분산 컴퓨팅 구조를  
TCP 위에서 **놀라울 만큼 안정적으로 구현한 시스템**이었습니다.  
센서, 액추에이터, 제어 노드들이  
**서로 메시지로 느슨하게 연결된 상태에서도, 흐름은 명확히 살아 있었습니다.**

이 경험을 통해 저는 명확히 알게 되었습니다:
...
무엇보다도,  
**메시지를 먼저 설계하고**,  
그 위에 **흐름과 구조를 세우는 방식**이 가능하다고 경험했습니다.
